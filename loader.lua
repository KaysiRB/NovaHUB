...
local Script = Window.Tab("Home", 6026568198)
    local Folder = Script.Folder("Script", "A bunch of scripts you can use")
    Folder.Button("TOADS", "Execute", function()
        print("TOADS executed")
    end)
...
local Settings = Window.Tab("Home", 6026568198)
    local Folder = Home.Settings("UI", "A bunch of UI Settings")
    Folder.BinKey("ToggleGUI", "Execute", function()
        print("ToggleGUI Changed")
    end)
