...
-- Table pour les durées de notes
local noteDurations = {
    [""] = 15,
    [' '] = 30,
    ['-'] = 60,
...
-- Ajout du système pour calculer la durée d'une note (si nécessaire dans ton code)
local function calculateNoteDuration(note)
    return noteDurations[note] or 0 -- Retourne 0 si la note n'existe pas dans la table
end
