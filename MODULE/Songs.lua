...
Songs["Faded"] = {
    ftime = 120,
    scr = [[ [6s] 0 [ts] e [us] t [of] u [4j] 8 [ej] q [tj] e [yh] u
...
Songs["Blue bird"] = {
    ftime = 120,
    scr = [[ f j k [el] t u p [wk] r y [oj] e t u p
